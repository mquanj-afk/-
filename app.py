...
# 前回の保存データがあれば自動読み込み、なければ初期値を入れる
...
st.markdown("---")
with開く = st.expander("📜 本アプリの規約・プライバシーポリシー（Amazonアソシエイト・個人情報保護適応版）"):
    st.caption("""
